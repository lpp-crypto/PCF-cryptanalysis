...
\bottomrule
\end{tabular}
\caption{\label{tab:vdlpn-param}Parameter sets for the {\sf VDLPN} swallow wPRF, intended as targets for cryptanalysis.}
\end{table}
...
\begin{algorithm}[!ht]
  \caption{\label{alg:vdlpn}The {\sf VDLPN} wPRF \\
