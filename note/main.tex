...
\institute{
  ...
  \and
  Université Paris-Saclay, UVSQ, CNRS, Laboratoire de Mathématiques de Versailles, Versailles, France \\ \email{yann.rotella@uvsq.fr}
}
...
\noindent \textbf{Acknowledgements.} Christina Boura, Léo Perrin and Yann Rotella were partially supported through the France 2030 program under grant agreement No. ANR-22-PECY-0010 Cryptanalyse. Geoffroy Couteau acknowledges the support of the French Agence Nationale de la Recherche (ANR) under the France 2030 ANR Project ANR-22-PECY-003 SecureCompute. This work is supported by the ERC grant OBELiSC (101115790). 
