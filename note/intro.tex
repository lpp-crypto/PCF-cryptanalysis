...
Our aim in this Systematization of Knowledge (SoK) paper is to describe swPRFs, i.e., what they are, and why they are relevant in practice. This involves both a detailed survey of the literature, and a translation of their security goals away from asymptotics. To this end, we also propose cryptanalysis challenges, together with \texttt{Python} reference implementations of the swPRFs we describe: practical security can only be studied through cryptanalysis, and our goal is to simplify this analysis.
