...
Let $n$ and $k$ be positive integers. Let $F = \{F_K\}_{K \in \Z_2^k}$ be a keyed function family with $F_K : \Z_2^n \to \Z_2^n$. We say that $F$ %\cb{c'est $F$ ou $F_K$ ici ?}
...
%\gc{DOn't forget to add }\lp{done}
