...
\paragraph{References for this section:}  \cite{C:DGHIKS21} \cite{C:APRR24} (alternative constructions) 
...
The algorithmic description of the alternative mod-2/mod-3 wPRF is provided in Algorithm~\ref{alg:bipsw}. 
 ...
 \begin{algorithm}
  \caption{\label{alg:bipsw}The alternative mod-2/mod-3 wPRF} 
  \begin{algorithmic} 
...
\christina{Donner ici les avantages de cette construction}
One of the security arguments given by the designers of the above construction is that it cannot be approximated by any polynomial of low degree. This follows from the classical results of Razborov and Smolensky~\cite{Raz87,Smo87} that show that for $p$ and $q$ two distinct primes, the $\mod{p}$ function cannot be approximated by any low depth $\mod{q}$ circuit.
