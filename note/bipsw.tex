...
\begin{algorithm}[H]
  ...
  \begin{algorithmic}
    ...
    \State \textbf{Output:} $y \in \mathbb{Z}_2^t$
    
    \State $u \gets Kx \mod 6 \in \mathbb{Z}_6^m$ 
    ...
    \For{$i = 1$ to $m$}
      ...
      \EndIf
    \EndFor
    \State $y \gets B u \mod 2 \in \mathbb{Z}_2^t$
     \State \Return $y$
  \end{algorithmic}
\end{algorithm}
\end{minipage}
...
\cb{Si quelqu'un peut verifier le deuxième algo ce sera cool}
