...
\bottomrule
\end{tabular}
\caption{\label{tab:parameters_bipsw}Parameters for the lternative mod-2/mod-3 construction~\cite{TCC:BIPSW18}, intended as targets for cryptanalysis. \lp{ok wtf?}}
\end{table}
%%% Local Variables:
%%% mode: latex
