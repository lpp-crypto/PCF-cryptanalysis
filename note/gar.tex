...
We define the notion of \emph{stretch} $\mathsf{s} \geq 1$ as the integer in the expression  $m = \mathcal{O}(n^{\mathsf{s}})$. A fundamental question in the study of Goldreich’s construction is: how large can the stretch be for a fixed locality parameter $d$, while still maintaining security?
