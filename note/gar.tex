...
\begin{algorithm}
  ...
  \State \textbf{Input:} $k\in\{0,1\}^n$, $x\in [1,\ldots,A^n_d]^{m}$
    \State $y \gets \varepsilon$ \cb{c'est quoi $\varepsilon$?}\yr{C'est la string vide}
    \For{$i = 1$ to $m$}
