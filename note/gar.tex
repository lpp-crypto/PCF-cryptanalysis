...
This proposal can be instantiated to yield various cryptographic primitives, such as one-way functions (when $m = n$) or pseudorandom generators with polynomial stretch (when $m = \mathcal{O}(n)$).
